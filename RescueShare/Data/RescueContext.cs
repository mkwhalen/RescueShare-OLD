...
namespace RescueShare.Models
{
    public class RescueContext : IdentityDbContext<User>
    {
        ...
        public DbSet<UserDeniedDogBreed> UserDeniedDogBreeds { get; set; }
        public DbSet<UserDeniedDogAge> UserDeniedAges { get; set; }
        public DbSet<UserDeniedDogWeight> UserDeniedDogWeights { get; set; }
        public DbSet<UserDeniedTemperment> UserDeniedTemperments { get; set; }
